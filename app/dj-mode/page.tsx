    ...
    <div className="min-h-screen bg-[#0a0a0f] text-[#f1f5f9] flex flex-col overflow-hidden">
      ...
      <div className="px-8 pb-8 max-w-sm mx-auto w-full shrink-0">
        <button
          ...
          className="w-full bg-blue-500 hover:bg-blue-400 disabled:opacity-50 text-white font-bold py-4 rounded-xl text-lg transition active:scale-95 btn-animated mb-[40px]"
        >
